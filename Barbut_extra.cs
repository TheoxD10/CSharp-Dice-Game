...
namespace Barbut_
{
    public partial class Barbut_extra : Form
    {
        ...
        private void castig()
        {
            if (Numar_Random1 == Numar_Random2 && Numar_Random1 == 6)/// zarurile primului jucator 6/6
            {
                ok1++;
            ...
            if (Numar_Random3 == Numar_Random4 && Numar_Random3 == 6)/// zarurile celui de al doilea jucator 1/1
            {
                ok2++;
            ...
            if (Numar_Random3 == Numar_Random4 && Numar_Random3 == 6 && Numar_Random1 == Numar_Random2 && Numar_Random1 == 6)/// 1 1
            {
                ok1++;
                label2.Text = Convert.ToString(ok1);
                ok2++;
                ...
                Class1.winner = 3;
                Castigator y = new Castigator();
                y.Show();///zarurile ambilor jucatori 6/6
                button1.Enabled = true;
                return;
            }
            //////////////////////////////////////////////////////
        ...
        {
            Barbut_extra.ActiveForm.Dispose();
            Form f = new Open();
            f.Show();
        }
        ...
        private void Barbut_extra_Load(object sender, EventArgs e)
        {
